...
{
    public class MessageHTMLForBookingSuccessfullyModel
    {
        public MessageHTMLForBookingSuccessfullyModel(string subject, IEnumerable<string> to, string nameUser, int idAppointment, 
